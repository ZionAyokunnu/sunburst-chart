...
const SunburstChart = ({ nodes, links, width = 600, height = 600, onSelect, maxLayers = 2, showLabels = false, onBreadcrumbsChange, onVisibleNodesChange, onCoreChange }) => {
    ...
    useEffect(() => {
        ...
        if (thisCount !== prevCount.current) { // real data size changed
            ...
            onCoreChange === null || onCoreChange === void 0 ? void 0 : onCoreChange(null);
    ...
    useEffect(() => {
        ...
        links.forEach(link => {
            ...
            if (parent && child) {
                ...
                if (!parent.children.some((c) => c.id === child.id)) {
                    ...
                    const childWithRelationship = Object.assign(Object.assign({}, child), { weight: link.influence_weight, correlation: (_a = link.influence_score) !== null && _a !== void 0 ? _a : 0.1 // Default to 0.1 if not provided
                     });
        ...
        const root = d3.hierarchy(hierarchyData)
            ...
            .sort((a, b) => {
            var _a, _b, _c;
            const pid = (_a = a.parent) === null || _a === void 0 ? void 0 : _a.data.id;
            if (!pid)
                return 0;
            const scoreA = (_b = influenceScoreMap.get(`${pid}_${a.data.id}`)) !== null && _b !== void 0 ? _b : 0;
            const scoreB = (_c = influenceScoreMap.get(`${pid}_${b.data.id}`)) !== null && _c !== void 0 ? _c : 0;
        ...
        const path = svg.selectAll("path")
            ...
            .style("opacity", 0.9)
            .style("cursor", (d) => { var _a; return (((_a = d.children) === null || _a === void 0 ? void 0 : _a.length) ? "pointer" : "default"); })
            ...
            onBreadcrumbsChange === null || onBreadcrumbsChange === void 0 ? void 0 : onBreadcrumbsChange(trail);
            if (d.children && d.children.length > 0) {
                ...
                onCoreChange === null || onCoreChange === void 0 ? void 0 : onCoreChange(d.data.id);
                ...
                if (d.parent) {
                    ...
                    onCoreChange === null || onCoreChange === void 0 ? void 0 : onCoreChange(d.data.id); // panel now shows leaf details
        ...
        function clicked(event, p) {
            ...
            setPivotId(newPivot);
            onCoreChange === null || onCoreChange === void 0 ? void 0 : onCoreChange(newPivot);
